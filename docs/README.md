...
├── smoke_test.md                      (manual pre-release checklist — run before the release commit)
...
| [smoke_test.md](./smoke_test.md) | Manual pre-release checklist — network, printer, migration, UI wiring | Run before each release |
